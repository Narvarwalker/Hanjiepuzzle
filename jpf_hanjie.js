...
function swapPuzzle(e) {
   ...
   // switch statement to detemine which puzzle button triggered this function
    switch (puzzleID) {
       case "puzzle1":
         document.getElementById("puzzle").innerHTML = 
            drawPuzzle(puzzle1Hint, puzzle1Rating, puzzle1);
 ...
 function setupPuzzle() {
     ...
     document.getElementById("hanjieGrid").addEventListener("mouseup",
         function() {
            ...
            if (solved) alert("You Solved The Problem");
   ...
   );//Ends parameters addEventListener
}//Ends setup puzzle function   
 function setBackground(e) {
   ...
   //Changes backgroundColor based off 
